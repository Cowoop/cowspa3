...
class ResourceCreate(BasePage):
    ...
    def content(self):
        ...
        form.add_field('Picture', tf.INPUT(name="picture", id="picture", type="file", accept="image/*"), "Image dimensions should be 250x250.")
...
class ResourceManage(BasePage):
    ...
    def content(self):
        ...
        resource_edit_form.add_field("Picture", tf.INPUT(id="picture", type="file"), "Image dimensions should be 250x250.")
