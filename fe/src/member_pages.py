...
class MemberProfile(BasePage):
    ...
    def content(self):
        ...
        billing_pref_form.mode.radio2.label = tf.label("Customize Details")
        ...
        for country in data_lists.countries:
                billing_pref_form.details.custom.form.country.input.option = tf.OPTION(country['label'], value=country['name'])
