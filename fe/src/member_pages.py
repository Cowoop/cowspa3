...
def billing_pref_form():
    ...
    organization.radio1.input = tf.INPUT(type="text", id="existing_org", Class="field-input")
    ...
    organization_form.add_field('Organization Name', tf.INPUT(type='text', id='org_name', name='org_name').set_required())
    ...
    organization_form.add_field('Email', tf.INPUT(type='email', id='org_email', name='org_email').set_required())
