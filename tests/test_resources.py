...
def test_info():
    assert resourcelib.resource_resource.info(test_data.resource_id).name == test_data.resource_data['name']
    state = resourcelib.resource_resource.get(test_data.resource_id,'state')
